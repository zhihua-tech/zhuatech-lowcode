...
class EnterpriseControlApiTests {
    ...
    private static final String BODY="""
        {"controlNo":"ENT-LOWCODE-001","organizationCode":"ZH-SH","fiscalPeriod":"2026-08",
         ...
         "externalRef":"","idempotencyKey":"idem-lowcode-enterprise-001"}
        """;
    /**
     * 商业授权或定制开发请微信添加微信号zhuatech或zhuatech2进行咨询。
     */
    ...
    @Test void invalidPeriodAndChecksumAreRejected() throws Exception {
        mvc.perform(post("/api/enterprise/controls").with(httpBasic("operator","operator123"))
            .contentType(MediaType.APPLICATION_JSON).content(BODY.replace("2026-08","2026-13").replace("ENT-LOWCODE-001","ENT-LOWCODE-BAD")))
